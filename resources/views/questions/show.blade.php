            ...
            <div class="card">
                ...
                <div class="media">
                    <div class="d-fex flex-column vote-controls">
                        ...
                        <form id="up-vote-question-{{ $question->id }}" action="/questions/{{ $question->id }}/vote" method="POST" style="di">
                            @csrf
                        ...
                        <form id="down-vote-question-{{ $question->id }}" action="/questions/{{ $question->id }}/vote" method="POST" style="di">
                            @csrf
                            <input type="hidden" name="vote" value="-1">
                        </form>
                        ...
                        <form id="favorite-question-{{ $question->id }}" action="/questions/{{ $question->id }}/favorites" method="POST" style="di">
                            @csrf
