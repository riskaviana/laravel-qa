            ...
            <div class="card">
                ...
                <div class="card-title">
                    ...
                    <div class="d-fex flex-column vote-controls">
                        ...
                        <form id="up-vote-answer-{{ $answer->id }}" action="/answers/{{ $answer->id }}/vote" method="POST" style="di">
                            @csrf
                        ...
                        <form id="down-vote-answer-{{ $answer->id }}" action="/answers/{{ $answer->id }}/vote" method="POST" style="di">
                            @csrf
                            <input type="hidden" name="vote" value="-1">
                        </form>
                        @can ('accept', $answer)
                        ...
                        <form id="accept-answer-{{ $answer->id }}" action="{{ route('answers.accept', $answer->id) }}" method="POST" style="di">
                            @csrf
                        </form>
                        @else
                        @if ($answer->is_best)
